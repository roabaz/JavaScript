let products = [
  {
    ...
    full_search:
      "PIECES  Simply Green Pantalon Chilli Comfy. Cintura Elastizada. - Simply Green",
    price: 899,
    full_price: "",
    currency: "UYU",
    discount: "",
  ...
  },
  {
    ...
    full_search:
      "ONLY  Brownie Pantalón Vilda Tiro Medio Y Straight Fit - Brownie",
    price: 999,
    full_price: "",
    currency: "UYU",
    discount: "",
  ...
  },
  {
    ...
    full_search:
      "ONLY  Rose Brown Pantalon Laya Veltet. Flared Fit. - Rose Brown",
    price: 999,
    full_price: "1.099",
    currency: "UYU",
    discount: "9",
  ...
  },
  {
    ...
    full_search:
      "ONLY  Frosty Green Jersey Geena Tejido Manga Larga - Frosty Green",
    price: 999,
    full_price: "",
    currency: "UYU",
    discount: "",
  ...
  },
  {
    ...
    description:
      "Se puede lavar a máquina a un máximo de 30 °C - No utilizar productos blanqueadores - No secar en secadora - Planchar a baja temperatura. Planchar a una temperatura máxima de 100 °C - No limpiar en seco - Tejido: 100% Poliéster - Relleno: 100% Poliéster",
    sizes: ["M", "L", "XL", "XXL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "chaquetas",
  ...
  },
  {
    ...
    description:
      "Se puede lavar a máquina a un máximo de 40 °C -  No utilizar productos blanqueadores -  No secar en secadora",
    sizes: ["M", "L"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "chaquetas",
  ...
  },
  {
    ...
    description:
      "Se puede lavar a máquina a un máximo de 40 °C. No se pueden utilizar productos blanqueadores. Planchar a temperatura media. Se puede secar en secadora a baja temperatura. Colgar para secar.",
    sizes: ["S", "M", "L", "XL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "chaquetas",
  ...
  },
  {
    ...
    description:
      "Se puede lavar a máquina a media carga utilizando un centrifugado de corta duración y a un máximo de 30 °C No utilizar productos blanqueadores No secar en secadora Planchar a baja temperatura. Planchar a una temperatura máxima de 100 °C No limpiar en seco - 73% Algodón - 27% Poliéster",
    sizes: ["M", "L", "XL", "XXL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "camisas",
  ...
  },
  {
    ...
    description:
      "Se puede lavar a máquina a media carga utilizando un centrifugado de corta duración y a un máximo de 30 °C -  No utilizar productos blanqueadores -  No secar en secadora -  Planchar a temperatura media -  No limpiar en seco",
    sizes: ["XL", "XXL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "pantalones",
  ...
  },
  {
    ...
    full_search:
      "ONLY  Cherry Mahogany Pantalon Estampado De Lino - Cherry Mahogany",
    price: 1099,
    full_price: "1.499",
    currency: "UYU",
    discount: "26",
  ...
  },
  {
    ...
    full_search:
      "ONLY  Chinchilla Pantalon Jogger. Cintura Ajustable - Chinchilla",
    price: 999,
    full_price: "",
    currency: "UYU",
    discount: "",
...

  {
    ...
    description:
      "Se puede lavar a máquina a un máximo de 40 °C utilizando un programa para prendas delicadas No utilizar productos blanqueadores No secar en secadora Planchar a temperatura media No limpiar en seco Colgar para secar - 100% algodón",
    sizes: ["M", "L", "XL", "XXL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "camisetas",
  ...
  },
  {
    ...
    description:
      "Buzo de punto a rayas. Corte básico y escote redondo. Composición: 100% Algodón orgánico. Instrucciones de lavado: Lavar a máquina a 40ªC como máximo en progama de lavado suave. No usar blanqueador. No secar en secadora. Planchar a temperatura media. No lavar en seco. Colgar para secar.",
    sizes: ["1.5 Años", "2 Años", "4 Años"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "sweaters",
  ...
  },
  {
    ...
    description:
      "Leggings estampadas. Elástico en la cintura. Cómoda calidad elástica. Composición: 58% Algodón orgánico, 37% Modal, 5% Elastano. Instrucciones de lavado: Se puede lavar a máquina a media carga utilizando un centrifugado de corta duración y a un máximo de 30°C. No utilizar productos blanqueadores. No secar en secadora. Planchar a temperatura media. No limpiar en seco. Colgar para secar.",
    sizes: ["4 Meses", "6 Meses", "9 Meses", "1 Año"],
    brand: "NAME IT",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "pantalones",
    colors: "Deco Rose",
  ...
  },
  {
    ...
    description:
      "Pantalón deportivo con elástico ajustable en la cintura. Ajuste normal. Elástico en tobillos. Composición: 100% Algodón orgánico. Instrucciones de lavado: Lavar a máquina, media carga, ciclo de centrifugado corto a 40ºC. No usar blanqueador. No secar en secadora. Planchar a temperatura media. No lavar en seco.",
    sizes: ["2 Años"],
    brand: "NAME IT",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "pantalones",
  ...
  },
  {
    ...
    description:
      "Leggings lisa con elástico en la cintura y tejido con textura acanalada. Composición: 57% Algodón orgánico 38% Mezcla modal, 5% Elastano. Instrucciones de lavado: Se puede lavar a máquina a media carga utilizando un centrifugado de corta duración y a un máximo de 40°C. No utilizar productos blanqueadores. No secar en secadora. Planchar a temperatura media. No limpiar en seco. Colgar para secar.",
    sizes: ["2 Años", "5 Años"],
    brand: "NAME IT",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "pantalones",
  ...
  },
  {
    ...
    full_search:
      "NOISY MAY  Bright White Top Kerry Sin Una Manga - Bright White",
    price: 599,
    full_price: "799",
    currency: "UYU",
    discount: "25",
  ...
  },
  {
    ...
    full_search:
      "ONLY  Pumice Stone Camiseta Rolling Stones. Manga Corta - Pumice Stone",
    price: 999,
    full_price: "1.099",
    currency: "UYU",
    discount: "9",
  ...
  },
  {
    ...
    full_search:
      "ONLY PLAYONLY  Bijou Blue Sudadera Judiea Deportiva - Bijou Blue",
    price: 999,
    full_price: "1.299",
    currency: "UYU",
    discount: "23",
  ...
  },
  {
    ...
    description:
      "Cárdigan de punto. Corte básico y escote redondo. Botones en el pecho. Composición: 100% Algodón orgánico. Instrucciones de lavado: Lavar a máquina a 40ªC como máximo en progama de lavado suave. No usar blanqueador. No secar en secadora. Planchar a temperatura media. No lavar en seco. Colgar para secar.",
    sizes: ["4 Años", "6 Años"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "sweaters",
  ...
  },
  {
    ...
    description:
      "Buzo de punto. Corte básico y escote redondo. Composición: 100% Acrílico. Instrucciones de lavado: Lavar a máquina a 40ªC como máximo en progama de lavado suave. No usar blanqueador. No secar en secadora. Planchar a temperatura media. No lavar en seco. Colgar para secar.",
    sizes: ["6 Años", "7 a 8 Años", "9 a 10 Años"],
    brand: "NAME IT",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "sweaters",
    colors: "Dark Sapphire",
  ...
  },
  {
    ...
    description:
      "Buzo tejido de punto. Corte normal y cuello redondo. Manga larga. Prenda básica. Composición: 84% Viscosa, 14% Poliéster, 2% Elastano. Instrucciones de lavado: Lavar a máquina a 40°C como máximo en el programa de lavado suave. No usar blanqueador. No secar en secadora. Planchar a baja temperatura. No lavar en seco. Colgar para secar.",
  ...
  },
  {
    ...
    description:
      "Camiseta lisa de manga corta y cuello redondo. Bolsillo en el pecho. Composición: 60% Algodón orgánico, 40% Poliéster. Lavar a máquina a un máximo de 40 ° C con un programa de lavado suave. No usar blanqueador. No secar en secadora. Planchar a fuego medio. Colgar para secar.",
    sizes: ["7 a 8 Años", "9 a 10 Años", "13 a 14 Años"],
    brand: "NAME IT",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "camisetas",
    colors: "Zephyr",
  ...
  },
  {
    ...
    full_search:
      "ONLY  Black Pantalon Emily De Pana. Tiro Alto Mom Fit. - Black",
    price: 1499,
    full_price: "",
    currency: "UYU",
    discount: "",
  ...
  },
  {
    ...
    description:
      "Se puede lavar a máquina a un máximo de 30 °C No utilizar productos blanqueadores Se puede secar en secadora a baja temperatura Planchar a alta temperatura. Planchar a una temperatura máxima de 200 °C Lavado en seco (sin tricloroetileno) - 100% algodón",
    sizes: ["L", "XL", "XXL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "camisetas",
  ...
  },
  {
    ...
    description:
      "Se puede lavar a máquina a un máximo de 40 °C utilizando un programa para prendas delicadas No utilizar productos blanqueadores No secar en secadora Planchar a baja temperatura. Planchar a una temperatura máxima de 100 °C No limpiar en seco - 78% Viscosa 22% Poliéster",
    sizes: ["M", "L", "XL", "XXL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "sweaters",
  ...
  },
  {
    ...
    description:
      "Se puede lavar a máquina a un máximo de 40 °C utilizando un programa para prendas delicadas No utilizar productos blanqueadores No secar en secadora Planchar a temperatura media No limpiar en seco - 100% Acrílico",
    sizes: ["S", "M", "L", "XL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "sweaters",
  ...
  },
  {
    ...
    description:
      "Sweater de punto. Lavar del revés. Lavar con colores similares. No colgar durante el secado.",
    sizes: ["L"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "sweaters",
  ...
  },
  {
    ...
    description:
      "Se puede lavar a máquina a un máximo de 40 °C utilizando un programa para prendas delicadas No utilizar productos blanqueadores No secar en secadora Planchar a temperatura media No limpiar en seco - 100% algodón",
    sizes: ["M", "L", "XL", "XXL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "sweaters",
  ...
  },
  {
    ...
    full_search:
      "ONLY  Silver Lining Sweater Tejido Con Bolsillo - Silver Lining",
    price: 999,
    full_price: "1.299",
    currency: "UYU",
    discount: "23",
    ...
    description:
      "Se puede lavar a máquina a un máximo de 40 °C utilizando un programa para prendas delicadas - No utilizar productos blanqueadores - No secar en secadora - Planchar a temperatura media - No limpiar en seco - 51% viscosa 26% poliéster 23% poliamida",
    sizes: ["L", "XL", "XXL"],
    brand: "ONLY",
    ship: "Envío Estándar - Mirtrans: Envío sin costo en compras mayores a UYU 1.500 Costo normal: UYU 160.",
    category: "sweaters",
